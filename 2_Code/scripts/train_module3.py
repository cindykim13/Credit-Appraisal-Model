"""Retrain Module 3 — semi-supervised blend (70% domain + 30% default signal)"""
import sys
sys.path.insert(0, '.')
...
mod = Module3Business(verbose=True)
...
mod.save(MODELS_DIR / "module3.pkl")
print("\nSaved: models/module3.pkl")
